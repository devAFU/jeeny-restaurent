...
<div class="container">
     <div class="copyright-txt">
        ...
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-gardening-lite');?><?php if( is_home() && is_front_page()) {?>
        <a href="<?php echo esc_url('https://www.sktthemes.org/');?>" target="_blank"><?php esc_html_e('SKT Themes','skt-gardening-lite'); ?></a>
        <?php } else {?>
          <?php esc_html_e('SKT Themes','skt-gardening-lite'); ?>
        <?php } ?>
        </div>
     <div class="clear"></div>
</div>           
